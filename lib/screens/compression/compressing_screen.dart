...
class CompressingScreen extends StatefulWidget {
  ...
  @override
  State<CompressingScreen> createState() => _CompressingScreenState();
}

class _CompressingScreenState extends State<CompressingScreen> {
  ...
  Future<void> _start() async {
    try {
      await for (final progress in _compressionService.compressVideo(
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (_) => CompressionResultScreen(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.compress, size: 48, color: Theme.of(context).colorScheme.primary),
            ),
            ...
            Text(
              'Encoding offline using FFmpeg. Please keep the app open.',
  ...
  Widget _buildErrorView() {
    return Column(
      ...
      children: [
        ...
        const Text('Compression Failed', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
  ...
  Widget _buildCancelledView() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text('Compression Cancelled', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 24),
        FilledButton(
          onPressed: () => Navigator.of(context).popUntil((r) => r.isFirst),
          child: const Text('Back to Home'),
