...
class _CompressionResultScreenState extends State<CompressionResultScreen> {
  ...
  Widget build(BuildContext context) {
    final reduction = widget.originalSizeBytes > 0 && _compressedSizeBytes > 0
        ? (((widget.originalSizeBytes - _compressedSizeBytes) / widget.originalSizeBytes) * 100).clamp(0.0, 99.9)
        : 0.0;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Your compressed video is ready for sharing.',
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  Text('Compressed Size', style: Theme.of(context).textTheme.labelMedium),
                                  const SizedBox(height: 4),
                                  Text(
                                    filesize(_compressedSizeBytes),
                                    style: TextStyle(
