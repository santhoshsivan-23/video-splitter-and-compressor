...
class FlipResultScreen extends StatefulWidget {
  final File sourceFile;
  final File outputFile;
  final int originalSizeBytes;
  final FlipDirection direction;

  const FlipResultScreen({
    super.key,
  ...
  @override
  State<FlipResultScreen> createState() => _FlipResultScreenState();
}

class _FlipResultScreenState extends State<FlipResultScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Flip Complete'),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Video Flipped $dirLabel!',
                    style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold),
                  ),
                  const SizedBox(height: 8),
                  Text(
                    'Your flipped video is ready to use.',
