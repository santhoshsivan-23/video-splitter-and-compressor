...
import 'trim_result_screen.dart';
...
class _TrimmingScreenState extends State<TrimmingScreen> {
  ...
  Future<void> _start() async {
    try {
      await for (final progress in _trimService.trimVideo(
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Trimming Video'),
        ),
        body: Center(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.content_cut, size: 48, color: Theme.of(context).colorScheme.primary),
            ),
            ...
            Text(
              widget.reencode
                  ? 'Re-encoding frame-accurately offline using FFmpeg.'
                  : 'Performing fast lossless cut (stream copy).',
            ...
            OutlinedButton.icon(
              ...
              label: const Text('Cancel Trimming'),
  ...
  Widget _buildErrorView() {
    return Column(
      ...
      children: [
        ...
        const Text('Trimming Failed', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
  ...
  Widget _buildCancelledView() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text('Trimming Cancelled', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 24),
        FilledButton(
          onPressed: () => Navigator.of(context).popUntil((r) => r.isFirst),
          child: const Text('Back to Home'),
